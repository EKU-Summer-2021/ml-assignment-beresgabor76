...
class InsuranceDataTest(unittest.TestCase):
    ...
    def test_read_file(self):
        ...
        self.assertEqual((1338, 6), self.__data._InsuranceData__dataset_x.shape)
    ...
    def test_split_dataset(self):
        ...
        train_set_row_cnt = round(self.__data._InsuranceData__dataset.shape[0]\
    ...
    def test_normalize_data(self):
        ...
        self.__data.train_set_x[(self.__data.train_set_x >= 0) &
                                (self.__data.train_set_x <= 1)] = True
        all_in_interval = self.__data.train_set_x.to_numpy().all()
        self.assertEqual(True, all_in_interval)
        self.__data.test_set_x[(self.__data.test_set_x >= 0) &
                               (self.__data.test_set_x <= 1)] = True
        all_in_interval = self.__data.test_set_x.to_numpy().all()
        self.assertEqual(True, all_in_interval)

    def test_prepare(self):
        self.__data.prepare()
        train_set_row_cnt = int(self.__data._InsuranceData__dataset.shape[0]\
                                * (1 - self.__data._InsuranceData__test_size))
        self.assertEqual(train_set_row_cnt, self.__data.train_set_x.shape[0])
